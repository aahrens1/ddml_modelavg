...
global outpath /Users/kahrens/MyProjects/ddml_sjpaper/Simul/sim_WZ_linear
global outpath2 /Users/kahrens/MyProjects/ddml_applied/sim_WZ_linear/output
cap mkdir $outpath
global folder out 
cd sim_WZ_linear
...
foreach i in bbias bbiassd  {
	...
	foreach m in md mn {
		label var ddml_x_1_`m'_`i'`f' "DDML & OLS TWI (K=`f')"
		label var ddml_x_2_`m'_`i'`f' "DDML & OLS QSI (K=`f')"
		label var ddml_x_3_`m'_`i'`f' "DDML & CV lasso TWI (K=`f')"
...
gen estimator_desc = ""
replace estimator_desc = "OLS (TWI)" if regexm(estimator,"ddml_x_1_md") 
replace estimator_desc = "OLS (QSI)" if regexm(estimator,"ddml_x_2_md")
replace estimator_desc = "Lasso with CV (TWI)" if regexm(estimator,"ddml_x_3_md")
...
foreach final in singlebest nnls1 {
	...
	gen estimator_desc = ""
	replace estimator_desc = "OLS (TWI)" if regexm(estimator,"1") & !regexm(estimator,"10") 
	replace estimator_desc = "OLS (QSI)" if regexm(estimator,"2")
	replace estimator_desc = "Lasso with CV (TWI)" if regexm(estimator,"3")
